...
export class AwsStack extends TerraformStack {
  constructor(scope: Construct, name: string) {
    ...
    const { privateSubnet1a, privateSubnet1b, publicSubnet1a, publicSubnet1b } =
      buildNetworkStack(mainVpc);
    ...
    const publicSubnetAlbTargetGroup = new AlbTargetGroup(
      this,
      "public-subnets-alb-target-group",
      {
    ...
    const cloudWatchLogGroupNginx = new CloudwatchLogGroup(
      this,
